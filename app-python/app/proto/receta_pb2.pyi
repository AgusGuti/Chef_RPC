...
class Receta(_message.Message):
    __slots__ = ["idReceta", "user", "tituloReceta", "descripcion", "categoria", "pasos", "ingredientes", "tiempoPreparacion", "foto1", "foto2", "foto3", "foto4", "foto5", "comentario", "puntaje", "baja"]
    ...
    BAJA_FIELD_NUMBER: _ClassVar[int]
    idReceta: int
    user: _user_pb2.User
    tituloReceta: str
    descripcion: str
