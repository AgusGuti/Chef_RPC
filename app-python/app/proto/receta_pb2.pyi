...
class Receta(_message.Message):
    __slots__ = ["idReceta", "user", "tituloReceta", "descripcion", "categoria", "pasos", "ingredientes", "tiempoPreparacion", "foto1", "foto2", "foto3", "foto4", "foto5", "comentario", "puntaje"]
